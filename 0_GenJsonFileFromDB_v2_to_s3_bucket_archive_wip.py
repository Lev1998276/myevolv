...
# Moving the file from EC2 to S3
local_file_path = "hospitalization.json"
s3_bucket_name = "vnsny-das-landing-test"
s3_key = "OUTGOING/MYEVOLV/ENCOUNTER_ALERTS/hospitalization.json"
s3_archive_folder = "OUTGOING/MYEVOLV/ENCOUNTER_ALERTS/ARCHIVE"

if not os.path.isfile(local_file_path):
    print(f"Error: Local file '{local_file_path}' not found.")
else:
    move_to_s3(local_file_path, s3_bucket_name, s3_key,s3_archive_folder)